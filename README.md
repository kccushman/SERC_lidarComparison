...
## Data folder
- "GEDI" folder: GEDI data from the initial ~ 4 year deployment over the SERC NEON study area.
...
- TransectStatsAndFigures.R : analyze 80 x 5 m transect data from TLS, MLS, ULS, and ALS point clouds to produce results and figures for the manuscript

## Results folder
Contains data-based figures are results produced from the included Data and Code, as numbered in the manuscript
